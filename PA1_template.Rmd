...
```{r impute, cache = TRUE, echo = FALSE}
...
ggplot(activity_imputed, aes(x = date, y = steps)) + stat_summary(fun.y = sum, geom = "bar") +  xlab("Date") + ylab("Steps") + ggtitle("Total Steps per Day")
```
